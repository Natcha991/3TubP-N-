        ...
        <div className="flex-1 flex items-start justify-center pt-5">
              ...
              <div className="inline-flex space-x-6 pb-4 pt-7 pl-4" style={{ width: 'max-content' }}>
                {conditions.map((condition, index) => (
                  <button
                    ...
                    className={`
                      relative flex items-center animate-sizeUpdown mt-[-1rem] justify-center px-6 py-8 rounded-2xl min-w-max transition-all duration-200 shadow-sm whitespace-nowrap
                      ${selectedConditions.includes(condition)
                        ? 'bg-white border-2 border-orange-400 shadow-md scale-115'
                        : 'bg-white/80 border-2 border-gray-200 hover:border-gray-300 scale-90'
                      }
                    `}
                  >
                    <span className={`
          ...
          <div className="absolute right-0 top-[30rem] z-102 -translate-y-55 transform translate-x-25 md:translate-x-12">
            <div className="absolute animate-showUp z-105 left-[-4rem] top-[2.5rem] w-[140px] h-[100px]">
              ...
              <div className="bg-white text-[0.8rem] shadow-xl  absolute text-center top-[3rem] left-[-5rem] px-[1rem] pt-[1.8rem] pb-[1rem] rounded-2xl rounded-br-none">
                <h1>สุขภาพของแต่ละคนไม่เหมือนกัน ดังนั้นนายมีเงื่อนไขหรือข้อจำกัดอะไร บอกมาได้เลย
                  ผมจะออกแบบเนื้อหาที่เหมาะกับ
                  นายให้เอง!</h1>
              </div>
            </div>
            <img
          ...
          <div className="absolute bottom-[591px] left-0 right-0 flex justify-center font-prompt">
