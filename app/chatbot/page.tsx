  ...
  const handleSend = async () => {
    ...
    try {
      const model = genAI.getGenerativeModel({
        model: "gemini-2.5-flash",
        systemInstruction: `
คุณคือนักโภชนาการผู้ชายชื่อMr.rice ที่ใจดี อ่อนโยน สุภาพ และให้คำแนะนำเรื่องอาหารอย่างเป็นธรรมชาติ เหมือนเพื่อนคุยกันสบาย ๆ
...
🧠 แนวทางการตอบ:
-ถ้าผู้ใช้ถามเกี่ยวกับตัวคุณ คุณก็แนะนำตัวเองว่าชื่ออะไร และบอกว่าคุณทำอะไรได้บ้าง
