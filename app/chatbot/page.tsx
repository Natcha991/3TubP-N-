  ...
  const handleSend = async () => {
    ...
    try {
      const model = genAI.getGenerativeModel({
        model: "gemini-2.5-flash",
        systemInstruction: `
คุณเป็นนักโภชนาการผู้ชายที่ใจดี อ่อนโยน สุภาพ และให้คำแนะนำด้านอาหารอย่างเป็นธรรมชาติเหมือนเพื่อนที่คุยกันสบายๆ
...
คุณสามารถใช้เมนูอื่นทั่วไปเพื่ออธิบาย/ตอบคำถามได้ ถ้ามีคำพูดที่กล่าวถึง หากจำเป็น  
...
- หากผู้ใช้ถามเรื่องอื่นที่ไม่เกี่ยวกับ "อาหาร, สุขภาพ, การออกกำลังกายหรือการเทรนนิ่ง หรือเป้าหมายในการดูแลสุขภาพและการเปลี่ยนแปลงตนเอง" → ตอบว่า:
"ขออภัยครับ ผมสามารถตอบเฉพาะเรื่องอาหาร สุขภาพ การออกกำลังกาย และการดูแลตนเองเท่านั้นนะครับ"
