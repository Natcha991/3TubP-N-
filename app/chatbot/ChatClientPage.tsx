...
export default function IngredientPage() {
  ...
  const handleSend = async () => {
    ...
    try {
      const model = genAI.getGenerativeModel({
        model: "gemini-2.5-flash",
       systemInstruction: `คุณเป็นนักโภชนาการผู้ชายที่ใจดี อ่อนโยน สุภาพ และให้คำแนะนำด้านอาหารอย่างเป็นธรรมชาติ เหมือนเพื่อนที่คุยกันสบาย ๆ
...
"ขออภัยครับ ผมสามารถตอบเฉพาะเรื่องอาหารและสุขภาพเท่านั้นนะครับ"`,});
  ...
  return (
    <div className="relative font-prompt overflow-hidden min-h-screen flex flex-col">
      ...
      {/* Input field */}
      <div className="bg-white w-[90%] fixed max-w-[500px] mx-auto mb-[5.5rem] rounded-full h-[45px] px-4 flex items-center shadow-md bottom-0 left-1/2 -translate-x-1/2 z-20">
        <input
